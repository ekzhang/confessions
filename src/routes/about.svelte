...
<div class="content">
  ...
  <p>
    The TODOs page illustrates SvelteKit's data loading and form handling. Try
...
<style lang="postcss">
  ...
  p {
    @apply bg-gradient-to-br from-purple-300 to-blue-500 rounded-lg p-4 my-2 font-medium text-2xl;
  }

  pre {
    @apply border-4 border-green-600 bg-green-100 rounded-lg text-2xl font-semibold p-4;
  }
</style>
